                    ...
                    <div class="sildebar__category--title">
                        ...
                        <ul>
                            @foreach ($category as $category)
                                <li><a
                                        href="{{ route('product.DisplayProductsByType', ['MaDanhMuc' => $category->MaDanhMuc]) }}">{{ $category->TenDanhMuc }}</a>
                                </li>
                                <hr style="border: 1px solid black">
                            @endforeach
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                            ...
                            <div class="sale__product--card">
                                ...
                                <div class="sale_product--price">
                                    ...
                                    @if ($product->PhanTramGiamGia == 0)
                                        <h4>{{ number_format($product->Gia, 0, ',', '.') }} vnd</h4>
                                    @else
                                        @php
                                            $salePrice =
                                        ...
                                        <h5>{{ number_format($product->Gia, 0, ',', '.') }} vnd</h5> <span>Sale</span>
                                    @endif
